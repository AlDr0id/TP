...
public class WolfAndSheepAction implements GameAction<WolfAndSheepState, WolfAndSheepAction> {
	...
	/**
	 * Devuelve la fila destino de la accion
	 * @return fila
	 */
	public int getRow() {
		return row;
	...
	/**
	 * Devuelve la columna destino de la accion
	 * @return columna
	 */
	public int getCol() {
		return col;
	...
	/**
	 * Devuelve la fila origen de la accion
	 * @return fila
	 */
	...
	/**
	 * Devuelve la columna origen de la accion
	 * @return columna
	 */
