...
/**
 * Constructora para crear un estado de juego nuevo
 * @param playerCount numero de jugadores
 */
  ...
  //  public abstract int[][] getBoard();
     ...
     * @return booleano a true si es valida o a false si no
     * */    
    public abstract boolean isValid(GameAction action);
    /**
    ...
    public double evaluate(int playerNumber) {
        return isFinished() ? (playerNumber == getWinner() ? 1 : -1) : 0;
