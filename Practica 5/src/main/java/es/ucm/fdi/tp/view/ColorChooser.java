...
public class ColorChooser extends JDialog {
	...
	/**
	 * Constructora para el selector de color
	 * @param parent ventana donde se coloca
	 * @param title titulo para el elemento
