...
public class MainPr4 {
	...
	public static void main(/*String[] args*/ String... args) {
		...
		try{
		GameState<?, ?> initialState = MainPr4.createInitialState(args[0]);// Intenta crear un juego
		if(initialState.getPlayerCount()== args.length-1){ // Si coinciden los argumentos
			...
			jugador = MainPr4.createPlayer(args[0], args[i+1], "Jugador" + (i+1)); //Creas los jugadores
			lista.add(jugador);// y los metes en la lista
			}
			MainPr4.playGame(initialState, lista);
		}
